...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login (use navigate action to http://localhost:5000/login)
        await page.goto("http://localhost:5000/login")
        
        # -> Navigate to /payment-history (use navigate action to http://localhost:5000/payment-history).
