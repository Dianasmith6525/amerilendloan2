...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /check-offers (use explicit navigate to http://localhost:5000/check-offers).
        await page.goto("http://localhost:5000/check-offers")
        
        # -> Type 'Alex' into the First Name field (index 1754) and then click the 'Check My Offers' button (index 1925).
        ...
        # -> Type 'Johnson' into Last Name (index 1755) and click 'Check My Offers' (index 1925) to re-submit the form and trigger offers/results.
        frame = context.pages[-1]
        # Input text
