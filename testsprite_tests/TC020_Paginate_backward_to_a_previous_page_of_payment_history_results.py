...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /payment-history using explicit navigate (test step requires exact path).
        ...
        assert await frame.locator("xpath=//*[contains(., 'list of payments')]").nth(0).is_visible(), "Expected 'list of payments' to be visible"
        assert await frame.locator("xpath=//*[contains(., 'current page indicator')]").nth(0).is_visible(), "Expected 'current page indicator' to be visible"
