...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /contact using the explicit navigate action as specified in the test steps.
        await page.goto("http://localhost:5000/contact")
        
        # -> Type 'Alex Johnson' into the Full Name field (input index 1777).
        ...
        # -> Type the message into the Message textarea (index 1781) and then click the Send Message/Submit button (index 1971) to submit the form.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div[2]/div/section[2]/div/div[2]/form/div[3]/textarea').nth(0)
        await asyncio.sleep(3); await elem.fill('I would like more information about your loan terms and repayment options.')
