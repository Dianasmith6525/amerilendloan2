...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /payment-history by using the explicit navigate action (no clickable navigation elements available on the current page).
        ...
        assert await frame.locator("xpath=//*[contains(., 'Transaction')]").nth(0).is_visible(), "Expected 'Transaction' to be visible"
