import{j as e}from"./query-DA_-xggs.js";import{a as s}from"./router-Ba9FtSmB.js";import{C as c,g as h,B as l,ae as g,af as f}from"./index-BMmq1qO5.js";import{A as y}from"./arrow-left-DFZWI4JV.js";import{D as b}from"./download-WDG_dfid.js";import"./ui-BlRfrP_E.js";import"./charts-B9AAC6-a.js";const w=`# Loan Agreement
...
`,E=`# Electronic Signature Consent
...
`,T=`# Truth in Lending Disclosure\r
\r
...
\r
- Interest charges\r
- Origination fee (if applicable)\r
\r
**APR Range:** 5.99% – 35.99%\r
\r
...
### 3. Amount Financed\r
\r
The **Amount Financed** is the amount of credit provided to you or on your behalf. This is the loan principal minus any prepaid finance charges (such as an origination fee deducted at disbursement).\r
\r
...
### Origination Fee\r
\r
AmeriLend may charge an origination fee of **0% – 8%** of the loan amount. If applicable, this fee is:\r
\r
- Clearly disclosed before you sign the loan agreement\r
- Either deducted from the loan proceeds at disbursement or added to the loan balance\r
\r
### Late Payment Fee\r
\r
...
`,S={"loan-agreement":{title:"Loan Agreement",description:"Official loan agreement document with terms and conditions",content:w},"privacy-policy":{title:"Privacy Policy",description:"Our commitment to protecting your personal information",content:v},"terms-of-service":{title:"Terms of Service",description:"Terms and conditions for using AmeriLend services",content:A},"esign-consent":{title:"E-Signature Consent",description:"Your consent to use electronic signatures for legal documents",content:E},"truth-in-lending":{title:"Truth in Lending Disclosure",description:"Federal Truth in Lending Act disclosure with loan terms, APR, and fee information",content:T}};function F(){const[L,d]=s("/legal/:document"),[R,u]=s("/public/legal/:document"),i=(d||u)?.document||"",a=S[i];if(!a)return e.jsx("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:61",className:"min-h-screen bg-gradient-to-br from-[#f8f9fa] to-[#e9ecef] flex items-center justify-center",children:e.jsx(c,{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:62",className:"p-8 text-center",children:e.jsx("p",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:63",className:"text-gray-600",children:"Document not found"})})});const m=()=>{const o=document.createElement("a");o.setAttribute("href",`data:text/plain;charset=utf-8,${encodeURIComponent(a.content)}`),o.setAttribute("download",`${i}.md`),o.style.display="none",document.body.appendChild(o),o.click(),document.body.removeChild(o)},p=()=>{window.print()};return e.jsxs("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:87",className:"min-h-screen bg-gradient-to-br from-[#f8f9fa] to-[#e9ecef]",children:[e.jsx(h,{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:88",title:`${a.title} | Legal`,description:a.description,path:`/legal/${i}`}),e.jsx("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:94",className:"bg-gradient-to-r from-[#0033A0] to-[#002070] text-white sticky top-0 z-40 shadow-lg",children:e.jsxs("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:95",className:"max-w-5xl mx-auto px-4 py-6 sm:px-6 lg:px-8",children:[e.jsxs("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:96",className:"flex items-center justify-between mb-4",children:[e.jsxs("button",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:97",onClick:()=>window.history.back(),className:"flex items-center gap-2 hover:opacity-80 transition-opacity",children:[e.jsx(y,{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:101",className:"w-5 h-5"}),e.jsx("span",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:102",children:"Back"})]}),e.jsxs("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:104",className:"flex items-center gap-3",children:[e.jsxs(l,{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:105",onClick:m,variant:"outline",className:"bg-white/20 border-white/30 text-white hover:bg-white/30 gap-2",children:[e.jsx(b,{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:110",className:"w-4 h-4"}),e.jsx("span",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:111",className:"hidden sm:inline",children:"Download"})]}),e.jsxs(l,{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:113",onClick:p,variant:"outline",className:"bg-white/20 border-white/30 text-white hover:bg-white/30 gap-2",children:["🖨️",e.jsx("span",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:119",className:"hidden sm:inline",children:"Print"})]})]})]}),e.jsxs("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:123",children:[e.jsx("h1",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:124",className:"text-3xl sm:text-4xl font-bold mb-2",children:a.title}),e.jsx("p",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:127",className:"text-blue-100",children:a.description})]})]})}),e.jsxs("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:133",className:"max-w-5xl mx-auto px-4 py-12 sm:px-6 lg:px-8",children:[e.jsx(c,{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:134",className:"bg-white shadow-2xl overflow-hidden border-0",children:e.jsx("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:135",className:"p-8 sm:p-12 bg-gradient-to-b from-white via-white to-blue-50",children:e.jsx("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:136",className:"markdown-content space-y-6 text-gray-800 prose-headings:font-bold prose-headings:mb-4",children:e.jsx(g,{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:137",remarkPlugins:[f],components:{h1:({node:o,children:n,...t})=>e.jsx("h1",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:141",className:"text-4xl md:text-5xl font-bold bg-gradient-to-r from-[#0033A0] to-[#FFA500] bg-clip-text text-transparent mb-6 border-b-4 border-gradient-to-r from-[#0033A0] to-[#FFA500] pb-4 mt-8",...t,children:n}),h2:({node:o,children:n,...t})=>e.jsx("h2",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:149",className:"text-3xl md:text-4xl font-bold text-[#0033A0] mt-10 mb-4 pl-4 border-l-4 border-[#FFA500] bg-gradient-to-r from-blue-50 to-transparent py-2",...t,children:n}),h3:({node:o,children:n,...t})=>e.jsx("h3",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:157",className:"text-2xl md:text-3xl font-bold text-[#002070] mt-8 mb-3 pl-4 border-l-4 border-[#003399]",...t,children:n}),h4:({node:o,children:n,...t})=>e.jsx("h4",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:165",className:"text-xl md:text-2xl font-semibold text-[#003399] mt-6 mb-2",...t,children:n}),h5:({node:o,children:n,...t})=>e.jsx("h5",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:173",className:"text-lg font-semibold text-[#005acc] mt-4 mb-2",...t,children:n}),h6:({node:o,children:n,...t})=>e.jsx("h6",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:181",className:"text-base font-semibold text-[#0066ff] mt-4 mb-2",...t,children:n}),p:({node:o,children:n,...t})=>e.jsx("p",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:189",className:"text-gray-700 leading-relaxed mb-4 text-base md:text-lg",...t,children:n}),strong:({node:o,children:n,...t})=>e.jsx("strong",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:197",className:"font-bold text-[#0033A0] bg-gradient-to-r from-blue-100 to-orange-100 px-2 py-1 rounded shadow-sm",...t,children:n}),em:({node:o,children:n,...t})=>e.jsx("em",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:205",className:"italic text-[#003399] font-semibold",...t,children:n}),ul:({node:o,children:n,...t})=>e.jsx("ul",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:210",className:"list-disc list-outside space-y-3 my-6 ml-8 text-gray-700 bg-gradient-to-b from-blue-50/50 to-transparent p-4 rounded-lg",...t,children:n}),ol:({node:o,children:n,...t})=>e.jsx("ol",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:218",className:"list-decimal list-outside space-y-3 my-6 ml-8 text-gray-700 bg-gradient-to-b from-orange-50/50 to-transparent p-4 rounded-lg",...t,children:n}),li:({node:o,children:n,...t})=>e.jsx("li",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:226",className:"text-gray-700 text-base md:text-lg leading-relaxed",...t,children:n}),blockquote:({node:o,children:n,...t})=>e.jsx("blockquote",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:231",className:"border-l-4 border-[#FFA500] bg-gradient-to-r from-blue-50 via-orange-50 to-blue-50 italic pl-6 py-4 my-6 text-gray-800 rounded-r-lg shadow-md font-semibold",...t,children:n}),table:({node:o,children:n,...t})=>e.jsx("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:239",className:"overflow-x-auto my-6 rounded-lg shadow-lg border-2 border-[#0033A0]",children:e.jsx("table",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:240",className:"w-full border-collapse",...t,children:n})}),thead:({node:o,children:n,...t})=>e.jsx("thead",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:249",className:"bg-gradient-to-r from-[#0033A0] via-[#002070] to-[#003399] text-white font-bold",...t,children:n}),tbody:({node:o,children:n,...t})=>e.jsx("tbody",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:257",className:"bg-white",...t,children:n}),tr:({node:o,children:n,...t})=>e.jsx("tr",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:262",className:"border-b-2 border-blue-200 hover:bg-gradient-to-r hover:from-blue-50 hover:to-orange-50 transition-all duration-200",...t,children:n}),th:({node:o,children:n,...t})=>e.jsx("th",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:267",className:"border-b-2 border-white px-4 py-4 text-left font-bold text-white",...t,children:n}),td:({node:o,children:n,...t})=>e.jsx("td",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:275",className:"border-r border-blue-200 px-4 py-3 text-gray-700",...t,children:n}),code:({node:o,inline:n,children:t,...r})=>n?e.jsx("code",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:284",className:"bg-gradient-to-r from-orange-100 to-blue-100 text-[#0033A0] px-2 py-1 rounded font-mono text-sm font-semibold shadow-sm",...r,children:t}):e.jsx("pre",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:291",className:"bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-green-400 px-4 py-4 rounded-lg font-mono text-sm block my-6 overflow-x-auto shadow-xl border-l-4 border-[#FFA500]",children:e.jsx("code",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:292",...r,children:t})}),a:({node:o,href:n,children:t,...r})=>e.jsx("a",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:298",href:n,className:"text-[#0033A0] font-semibold underline hover:text-[#FFA500] hover:no-underline transition-all duration-200 hover:shadow-sm hover:bg-blue-50 px-1 rounded",target:"_blank",rel:"noopener noreferrer",...r,children:t}),hr:({node:o,...n})=>e.jsx("hr",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:309",className:"border-0 h-1 bg-gradient-to-r from-[#0033A0] via-[#FFA500] to-[#0033A0] my-8 rounded shadow-md",...n})},children:a.content})})})}),e.jsxs("div",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:323",className:"mt-12 text-center bg-gradient-to-r from-[#0033A0]/10 to-[#FFA500]/10 p-6 rounded-lg",children:[e.jsxs("p",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:324",className:"text-sm text-gray-600 font-semibold",children:["© ",new Date().getFullYear()," AmeriLend. All rights reserved. This document is confidential and for authorized use only."]}),e.jsxs("p",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:328",className:"text-xs mt-2 text-gray-500",children:["Last updated: ",new Date().toLocaleDateString()]})]})]}),e.jsx("style",{"data-loc":"client\\src\\pages\\LegalDocuments.tsx:335",children:`
        @media print {
          body {
            background: white;
          }
